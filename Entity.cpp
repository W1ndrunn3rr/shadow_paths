...
int Player::getArmorLevel() const {
    return armorLevel;
}

int Player::getShards() const {
    return shardsAmount;
}
...
int Player::getPotionsLevel() const {
    return potionLevel;
}
...
void Player::gainShard(int shard) {
    shardsAmount = shardsAmount + shard;
}
...
void Player::setArmor(int armorPoints) {
   armor = armorPoints;
}
...
int Player::getDamageDone() const {
