...
Boss::Boss(int arm, int maxHP, const std::string& name, int max, int min, Player &player, int criticalChance, int dex) : Enemy(arm,
                                                                                                                               maxHP,
                                                                                                                               name, max,
                                                                                                                               min,
                                                                                                                               player,
...
Banshee::Banshee(int arm, int maxHP, const std::string& name, int max, int min, Player &player, int criticalChance, int dex) : Boss(arm,
                                                                                                                                    maxHP,
                                                                                                                                    name,
                                                                                                                                    max,
                                                                                                                                    min,
